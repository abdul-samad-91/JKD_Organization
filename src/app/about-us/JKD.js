    ...
    <section className='bg-[#eefbff] w-full flex flex-col items-center my-10 py-10'>
        <div className='w-[1200px]'>
            <div className='flex  gap-5 '>
                <div className='w-[40%]'>
                    <h2 className='text-[30px] font-semibold'>Introduction</h2>
                    <p className=' text-justify  text-gray-700'>JKD Pakistan is a dynamic organization dedicated to empowering marginalized & under-served communities through sustainable economic opportunities and social development. Through its diverse and innovative programs and services, JKD Pakistan bridges the gap for vulnerable generations, ensuring equal access to opportunities and cultivating resilient communities for a brighter future.</p>
                    <h2 className=' text-[30px] pt-6 font-semibold'>Mssion</h2>
                    <p>Empowering the under-served communities by creating sustainable economic opportunities</p>
                </div>
