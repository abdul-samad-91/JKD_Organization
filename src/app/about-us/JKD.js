        ...
        <div className='w-[1200px]'>
            <div className='flex items-center gap-5 '>
                <div className='w-[40%]'>
                    ...
                    <p className={` text-justify ${theme === 'light' ? ' text-gray-700 ':'text-white'} pt-4`}>JKD Pakistan is a dynamic organization dedicated to empowering marginalized & under-served communities through sustainable economic opportunities and social development. Through its diverse and innovative programs and services, JKD Pakistan bridges the gap for vulnerable generations, ensuring equal access to opportunities and cultivating resilient communities for a brighter future.</p>
                    <h3 className=' text-[30px]  font-semibold pt-4'>Mssion</h3>
                    <p className={` pt-4 ${theme === 'light' ? ' text-gray-700 pt-4':'text-white'}`}>Empowering the under-served communities by creating sustainable economic opportunities</p>
                </div>
