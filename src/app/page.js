      ...
      <div className={` flex flex-col items-center w-full`}>
        ...
        <div className={`${theme === 'light' ? 'bg-white':'bg-[#0b0b0b]'} w-full flex flex-col items-center mt-10 py-10`}>
          <div className='max-w-[950px] px-8'>
            <h2 className='text-5xl text-center font-bold text-[#4A709F] '>About <span className={`text-[#D08348] `}>JKD Pakistan</span></h2>
            <p className={` text-center  ${theme === 'dark' ? '' : 'text-gray-800'} pt-4  px-10`} >A nationally approved Training Institute and Events, Sports & Tourism Services Hub, delivering skills development, tourism & travel services, sports development programs, business incubation, community uplift events, and overseas employment opportunities.</p>
          </div>
        </div>
        <JKD />
